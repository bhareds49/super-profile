...
document.getElementById("test-btn").addEventListener("click", function() {
    ...
    fetch("http://127.0.0.1:5000/api/users/" + username).then((response)=>response.json()).then(function(data) {
        ...
        else document.getElementById("api-test").innerHTML = data.username;
    });
});
document.getElementById("login-btn").addEventListener("click", function() {
    ...
    fetch("http://localhost:5000/api/auth", {
        ...
        if (!data.token) document.getElementById("login-test").innerHTML = "Wrong credentials";
        else document.getElementById("login-test").innerHTML = "Logged In!";
    });
